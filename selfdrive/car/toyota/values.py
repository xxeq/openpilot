...
FW_VERSIONS = {
  ...
  CAR.CAMRY_TSS2: {
    ...
    (Ecu.srs, 0x780, None): [
      b'8917F33760\x00\x00\x00\x00\x00\x00',
    ],
    (Ecu.hvac, 0x7C4, None): [
      b'8865F3301801    ',
    ],
    (Ecu.transmission, 0x701, None): [
      b'\x018966533B9100\x00\x00\x00\x00',
    ],
    (Ecu.combinationMeter, 0x7c0, None): [
      b'\x038380033R4136\x00\x00\x00\x008380033R4226\x00\x00\x00\x008380033R4324\x00\x00\x00\x00',
    ],
  },
  CAR.CHR: {
    (Ecu.engine, 0x700, None): [
